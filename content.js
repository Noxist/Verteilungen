...
$$`,
  ...
  },
  {
    ...
    formula: String.raw`$$P(A \cap B) = P(A) \cdot P(B\,|\,A)$$`,
    type: 'tree'
  },
  {
    id: 3,
    ...
    formula: String.raw`$$X: \Omega \to \mathbb{R}$$`,
    type: 'mapping'
  },
  {
    id: 4,
...
$$`,
  ...
  },
  {
    ...
    formula: String.raw`$$
\sigma^2 = \mathrm{Var}(X) = \sum (x_i - E(X))^2 p_i
$$`,
    type: 'variance'
  },
  {
  ...
  },
  {
    ...
    formula: String.raw`$$\begin{aligned}P(\mu \pm 1\sigma) &\approx 0{,}68\\
P(\mu \pm 2\sigma) &\approx 0{,}954\\
P(\mu \pm 3\sigma) &\approx 0{,}997\end{aligned}$$`,
    type: 'sigma'
  },
  {
    id: 12,
    ...
    formula: String.raw`$$P(X \ge 1) = 1 - (1-p)^n$$`,
    type: 'atleast'
  },
  {
    id: 13,
    ...
    formula: String.raw`$$B(n,p) \approx \mathcal{N}(np, np(1-p))$$`,
    type: 'approx'
  },
  {
    id: 14,
  ...
  },
  {
    ...
    formula: String.raw`$$\text{Nutze alle Regeln: Pfade, Erwartungswert, } B(n,p), \mathcal{N}(\mu,\sigma)$$`,
    type: 'quiz'
  }
];
